...
#define VGA_MAIN_PPCEXP0_POS_MASK             (1UL << 0)
#define GPIO0_MAIN_PPCEXP0_POS_MASK           (1UL << 1)
#define GPIO1_MAIN_PPCEXP0_POS_MASK           (1UL << 2)
#define GPIO2_MAIN_PPCEXP0_POS_MASK           (1UL << 3)
#define GPIO3_MAIN_PPCEXP0_POS_MASK           (1UL << 4)
...
#define MPC_SSRAM2_PERIPH_PPCEXP0_POS_MASK    (1UL << 1)
#define MPC_SSRAM3_PERIPH_PPCEXP0_POS_MASK    (1UL << 2)
/* End PERIPH PPCEXP0 peripherals definition */

/* PERIPH PPCEXP1 peripherals definition */
#define SPI0_PERIPH_PPCEXP1_POS_MASK          (1UL << 0)
#define SPI1_PERIPH_PPCEXP1_POS_MASK          (1UL << 1)
#define SPI2_PERIPH_PPCEXP1_POS_MASK          (1UL << 2)
#define UART0_PERIPH_PPCEXP1_POS_MASK         (1UL << 5)
#define UART1_PERIPH_PPCEXP1_POS_MASK         (1UL << 6)
#define UART2_PERIPH_PPCEXP1_POS_MASK         (1UL << 7)
#define UART3_PERIPH_PPCEXP1_POS_MASK         (1UL << 8)
#define UART4_PERIPH_PPCEXP1_POS_MASK         (1UL << 9)
#define I2C_0_PERIPH_PPCEXP1_POS_MASK         (1UL << 10)
#define I2C_1_PERIPH_PPCEXP1_POS_MASK         (1UL << 11)
...
#define FPGA_AUDIO_PERIPH_PPCEXP2_POS_MASK    (1UL << 1)
...
struct sse300_sysinfo_t {
    volatile uint32_t soc_indentity;  /* 0x000 (R/ ) SoC Identity Register */
